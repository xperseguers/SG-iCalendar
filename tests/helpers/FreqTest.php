...
class FreqTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDailyUntil()
    {
        ...
        self::assertEquals(882864000, $freq->previousOccurrence(time()));
    }
    ...
    public function testDailyBydayBymonthUntil()
    {
        ...
        foreach ($rules as $rule) {
            ...
            $freq = new SG_iCal_Freq($rule, $start);
            self::assertEquals(949305600, $freq->previousOccurrence(time()));
        }
    }
    ...
    public function testWeeklyUntil()
    {
        ...
        $freq = new SG_iCal_Freq($rule, $start);
        self::assertEquals(882864000, $freq->previousOccurrence(time()), 'Failed getting correct end date');
    }
    ...
    public function testWeeklyIntervalUntilByday()
    {
        ...
        $freq = new SG_iCal_Freq($rule, $start);
        self::assertEquals(882777600, $freq->previousOccurrence(time()), 'Failed getting correct end date');
    }
    ...
    */
    ...
    public function testFirstOccurrencesByYearDay()
    {
        ...
        $freq = new SG_iCal_Freq($rule, $start);
        self::assertEquals(strtotime('2009-10-27T09:00:00'), $freq->firstOccurrence());
        self::assertEquals(strtotime('2011-01-01T09:00:00'), $freq->nextOccurrence($start));
    }
    ...
    public function testFirstOccurrencesByYearDayWithoutFirstDate()
    {
        $rule = 'FREQ=YEARLY;INTERVAL=2;BYYEARDAY=1;COUNT=5';
        $start = strtotime('2009-10-27T090000');
        $freq = new SG_iCal_Freq($rule, $start, [$start]);
        self::assertEquals(strtotime('2011-01-01T09:00:00'), $freq->firstOccurrence());
    }
    ...
    public function testLastOccurrenceByYearDay()
    {
        ...
        $freq = new SG_iCal_Freq($rule, $start);
        self::assertEquals(strtotime('2019-01-01T09:00:00'), $freq->lastOccurrence());
    }
    ...
    public function testCacheCount()
    {
        ...
        $start = strtotime('2011-01-01T090000');
        $freq = new SG_iCal_Freq($rule, $start);
        self::assertEquals(5, count($freq->getAllOccurrences()));
        self::assertEquals(strtotime('2019-01-01T09:00:00'), $freq->lastOccurrence());
    }
