...
class DurationTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDurationDateTime()
    {
        ...
        self::assertEquals($this->secsDay * 10 + $this->secsHour * 6 + 20, $dur->getDuration());
    }
    ...
    public function testDurationWeek()
    {
        ...
        self::assertEquals($this->secsWeek * 2, $dur->getDuration());
    }
    ...
    public function testDurationNegative()
    {
        ...
        self::assertEquals(-1 * $this->secsDay, $dur->getDuration());
    }
